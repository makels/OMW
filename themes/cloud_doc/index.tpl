        ...
        <div class="large-6 columns">
          <div id="teaser-slider-2">
            <div class="flexslider">
              <ul class="slides">
                <li>
                  <img src="/themes/{$smarty.const.THEME_NAME}/images/slides/iphoneshots-1.jpg" alt="Petrichor - slider">
                </li>
                <li>
                  <img src="/themes/{$smarty.const.THEME_NAME}/images/slides/iphoneshots-2.jpg" alt="Petrichor - slider">
                </li>
                <li>
                  <img src="/themes/{$smarty.const.THEME_NAME}/images/slides/iphoneshots.jpg" alt="Petrichor - slider">
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          <div class="large-12 columns">
            ...
            <div class="row">
              ...
              <div class="small-4 columns hints iphone">
                <img src="/themes/{$smarty.const.THEME_NAME}/images/Iphone_Mockup.png" alt="">
              </div>
              <div class="small-4 columns hints iphone">
        ...
        <div class="row">
          <div class="large-12 columns">
            ...
            <ul class="clearing-thumbs small-block-grid-3" data-clearing>
              <li><a href="/themes/{$smarty.const.THEME_NAME}/images/screenshot-1b.png"><img src="/themes/{$smarty.const.THEME_NAME}/images/screenshot-1.png"></a></li>
              <li><a href="/themes/{$smarty.const.THEME_NAME}/images/screenshot-2b.png"><img src="/themes/{$smarty.const.THEME_NAME}/images/screenshot-2.png"></a></li>
              <li><a href="/themes/{$smarty.const.THEME_NAME}/images/screenshot-3b.png"><img src="/themes/{$smarty.const.THEME_NAME}/images/screenshot-3.png"></a></li>
              <li><a href="/themes/{$smarty.const.THEME_NAME}/images/screenshot-2b.png"><img src="/themes/{$smarty.const.THEME_NAME}/images/screenshot-2.png"></a></li>
              <li><a href="/themes/{$smarty.const.THEME_NAME}/images/screenshot-1b.png"><img src="/themes/{$smarty.const.THEME_NAME}/images/screenshot-1.png"></a></li>
              <li><a href="/themes/{$smarty.const.THEME_NAME}/images/screenshot-3b.png"><img src="/themes/{$smarty.const.THEME_NAME}/images/screenshot-3.png"></a></li>
              <li><a href="/themes/{$smarty.const.THEME_NAME}/images/screenshot-3b.png"><img src="/themes/{$smarty.const.THEME_NAME}/images/screenshot-3.png"></a></li>
